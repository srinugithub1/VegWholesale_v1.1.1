...
import TallyExport from "@/pages/tally-export";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/tally" component={TallyExport} />
      <Route path="/admin/deleted-records" component={DeletedRecords} />
...
function ProtectedApp() {
  ...
  useEffect(() => {
    ...
    if (isRestrictedAdmin) {
      ...
      const allowed = ['/', '/stock', '/reports', '/payments', '/completed-payments', '/sell', '/customer-edit', '/print', '/customers', '/admin/tally', '/products'];
